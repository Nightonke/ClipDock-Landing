...
const captions: Record<PublishedLocale, Record<string, string[]>> = { 'en-US': enCaptions, 'zh-Hans': zhCaptions, 'zh-Hant': hantCaptions, ja: jaCaptions, ko: koCaptions, es: esCaptions };
